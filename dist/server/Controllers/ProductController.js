...
var NewProduct = function (product) { return __awaiter(void 0, void 0, void 0, function () {
    var newProduct, response, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                newProduct = new product_1["default"]({
                    id: uuid_1.v4(),
                    name: product.name,
                    price: product.price,
                    stock: product.stock,
...
var ModifyProduct = function (product) { return __awaiter(void 0, void 0, void 0, function () {
    var productToModify;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, product_1["default"].findById(product._id)];
            case 1:
                productToModify = _a.sent();
                if (!productToModify)
                    return [2 /*return*/, null];
                ...
                return [4 /*yield*/, productToModify.save()];
            case 2:
                _a.sent();
                return [2 /*return*/, productToModify];
        }
    });
}); };
var ModifyProductImage = function (image, productId) { return __awaiter(void 0, void 0, void 0, function () {
    var product;
    return __generator(this, function (_a) {
        switch (_a.label) {
